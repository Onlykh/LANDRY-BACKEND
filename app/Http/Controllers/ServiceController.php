...
class ServiceController extends Controller
{
    ...
    {
        $service = $this->serviceService->findByReference($id, $request->input('with', []));
        if (!$service) {
     ...
     * @return JsonResponse
     */
    public function update(ServiceUpdateRequest $request, $id): JsonResponse
    {
        $service = $this->serviceService->findByReference($id);
        if (!$service) {
